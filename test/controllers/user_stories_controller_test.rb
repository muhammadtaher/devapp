...
class UserStoriesControllerTest < ActionController::TestCase
  ...
  test "should create user_story" do
    assert_difference('UserStory.count') do
      post :create, user_story: { description: @user_story.description, name: @user_story.name, project_id: @user_story.project_id }
    end
  ...
  test "should update user_story" do
    patch :update, id: @user_story, user_story: { description: @user_story.description, name: @user_story.name, project_id: @user_story.project_id }
    assert_redirected_to user_story_path(assigns(:user_story))
  end
